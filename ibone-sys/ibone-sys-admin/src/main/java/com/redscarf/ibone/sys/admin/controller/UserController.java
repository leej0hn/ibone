...
import com.redscarf.ibone.sys.core.service.*;
...
//        PageRequest pageRequest = new PageRequest(listModel.getPageNumber()-1,listModel.getPageSize(), Sort.Direction.fromString(listModel.getSortOrder()),listModel.getSortName());
        ...
        //分页查找
        PageInfo<RbacUserEntity> page = userService.findPage(listModel.getSearchText(),pageRequest);
        List<UserBaseInfoModel> list = userService.getUserBaseInfos(page.getList());
    ...
    public String toAssignRole(@PathVariable("id")String id, ModelMap modelMap){
        RbacUserEntity userEntity = userService.findById(Integer.parseInt(id));
        List<RbacRoleEntity> userRoles = roleService.findRolesByUserId(userEntity.getId());
        modelMap.put("userRoles",roleService.getSimpleModels(userRoles));
    ...
    public String toAssignMenu(@PathVariable("userId")String userId, ModelMap modelMap){
        ...
        List<RbacMenuEntity> menuEntityList = menuService.findMenusByUserId(userEntity.getId());
    ...
    public String toOrganization(@PathVariable("userId")String userId, ModelMap modelMap){
        ...
        RbacUserEntity userEntity = userService.findById(Integer.parseInt(userId));
        List<RbacOrganizationEntity> organizationEntities = organizationService.findOrganizationByUserId(userEntity.getId());
    ...
    public String toAssignPermission(@PathVariable("userId")String userId, ModelMap modelMap){
        ...
        List<RbacPermissionEntity> permissions = permissionService.findPermissionsByUserId(userEntity.getId());
