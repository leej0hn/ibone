package com.redscarf.ibone.sys.admin.handlers;
...
public class BindingExceptionHandler {
    ...
    @Around("execution(com.redscarf.ibone.common.ui.result.Result com.redscarf.ibone.sys.admin.controller.*.*(..))")
    public Result doAround(ProceedingJoinPoint pjp) throws Throwable {
        ...
        try {
            ...
            if(throwable instanceof IboneException){
                IboneException exception = (IboneException) throwable;
